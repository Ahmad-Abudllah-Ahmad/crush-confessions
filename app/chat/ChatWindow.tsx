...
export default function ChatWindow({ conversationId, currentUserId }: { conversationId: string; currentUserId: string }) {
  ...
  const handleBlockUser = async () => {
    ...
    try {
      ...
      setError(err.message || 'An error occurred while trying to block the user');
      console.error(err);
    } finally {
      setIsBlocking(false);
    }
    ...
    <div className="flex flex-col h-full">
      <div className="p-4 border-b border-gray-200 flex justify-between items-center">
        ...
        <div className="flex space-x-3">
          ...
          <button
            ...
            className={`focus:outline-none ${isBlocked ? 'text-gray-400 cursor-not-allowed' : 'text-gray-600 hover:text-gray-800'}`}
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-gray-50">
        {isBlocked && (
          <div className="bg-red-100 text-red-800 p-3 mb-4 rounded-md">
            You have blocked this user. You can no longer send or receive messages.
          </div>
        )}
              ...
              {msgs.map(message => (
                ...
                >
                  ...
                  >
                    ...
                    <p className={`text-xs ${message.isCurrentUser ? 'text-purple-200' : 'text-gray-500'}`}>
      ...
      >
        <input
          ...
          placeholder={isBlocked ? "You cannot send messages" : "Type your message..."}
